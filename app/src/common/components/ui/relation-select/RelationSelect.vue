<template>
    <Popover v-model:open="open">
        <PopoverTrigger as-child>
            <Button ref="triggerButton" variant="outline" role="combobox" :aria-expanded="open"
                class="w-full flex-1 justify-between" :class="triggerClass" :disabled="disabled">
        ...
        <PopoverContent :style="{ width: finalPopoverWidth }" class="p-0" align="start" @keydown="handleKeydown">
            ...
            <div class="max-h-60 overflow-y-auto" ref="scrollContainer">
                <div v-if="clearable && displayItem" :class="[
                ...
                <div v-if="!loading && items.length === 0 && !searchQuery"
