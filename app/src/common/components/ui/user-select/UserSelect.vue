<template>
    <RelationSelect v-model="selectedUser" :endpoint="endpoint" display-field="name" image-field="avatar"
        :filter="filter" subtitle-field="email" :extra-fields="['name', 'email', 'avatar']"
        placeholder="Sélectionner un utilisateur..." search-placeholder="Rechercher un utilisateur..."
        empty-message="Aucun utilisateur trouvé." :clearable="clearable" :disabled="disabled" :class="triggerClass">
