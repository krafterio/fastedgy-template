  ...
  <div class="space-y-4">
    ...
    >
      ...
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <div class="space-y-2">
          ...
          <p v-if="maxSize" class="text-xs text-muted-foreground">Taille maximum: {{ formatFileSize(maxSize) }}</p>
        </div>
      </div>
    </div>
    ...
    <div v-if="files.length > 0 && !hideSelectedFiles" class="space-y-2">
      <div class="flex items-center justify-between">
        ...
        <Button variant="ghost" size="sm" @click="clearFiles" class="h-auto p-1 text-xs"> Tout supprimer </Button>
      </div>
