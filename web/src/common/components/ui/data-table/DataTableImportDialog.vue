        ...
        <div class="flex-1 overflow-y-auto px-6">
          <div class="space-y-4 py-4">
            ...
            >
              ...
              <p class="text-sm font-medium mb-1" v-tc>Déposez un fichier ici ou cliquez pour sélectionner</p>
              <p class="text-xs text-muted-foreground" v-tc>Formats supportés : CSV, XLSX, ODS</p>
              <input ref="fileInput" type="file" accept=".csv,.xlsx,.ods" class="hidden" @change="handleFileSelect" />
            </div>
        ...
        <div class="flex-1 overflow-y-auto px-6">
          <div class="space-y-4 py-4">
            ...
            <div v-if="importResult.errors > 0" class="space-y-2">
              ...
              <div class="space-y-3">
                <Card v-for="(error, idx) in importResult.error_details" :key="idx" class="border-destructive">
                  <CardHeader class="pb-3">
                    <div class="flex items-start gap-3">
                      <AlertCircle class="w-5 h-5 text-destructive mt-0.5 flex-shrink-0" />
                      <div class="flex-1 min-w-0">
                        <CardTitle class="text-base"> <span v-tc>Ligne</span> {{ error.row }} </CardTitle>
