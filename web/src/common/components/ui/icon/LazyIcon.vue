<template>
  <div ref="iconContainer" class="flex w-8 h-8 items-center justify-center">
    <IconViewer v-if="isVisible" :name="name" :size="size" />
    <div v-else class="w-4 h-4 bg-muted animate-pulse rounded" />
  </div>
</template>
