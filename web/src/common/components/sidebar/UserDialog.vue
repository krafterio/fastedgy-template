  ...
  <Dialog :open="open" @update:open="$emit('update:open', $event)">
    <DialogContent class="sm:max-w-md">
      <DialogHeader>
        ...
        <DialogDescription v-tc> Personnalisez votre nom et votre avatar </DialogDescription>
      </DialogHeader>
      ...
      <div class="space-y-6 py-4">
        ...
        <div class="flex flex-col items-center space-y-4">
          ...
          <div class="text-center">
            ...
            <p class="text-xs text-muted-foreground mt-1" v-tc>JPG, PNG ou GIF (max. 2MB)</p>
          </div>
        </div>
