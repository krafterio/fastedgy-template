  ...
  <Dialog :open="open" @update:open="$emit('update:open', $event)">
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription v-tc> Glissez-déposez vos fichiers ou cliquez pour sélectionner </DialogDescription>
      </DialogHeader>
      ...
      >
        ...
        <p class="text-sm text-muted-foreground mb-2" v-tc>Glissez-déposez vos fichiers ici</p>
        <p class="text-xs text-muted-foreground" v-tc>ou cliquez pour sélectionner</p>
      </div>
